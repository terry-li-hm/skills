...
Also check `memory/user_financial_constraints.md` for context on Terry's financial situation.

The nudge: knows where Terry's financial data lives in the vault, the urgency thresholds, and how to cross-reference Praxis.md with vault notes. Baseline wouldn't know the file locations or financial context.
