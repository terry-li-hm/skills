---
name: food-menu
description: Parse restaurant menus from foodorder.today (世通) ordering system. Reference skill for scraping uni-app POS menus via CDP.
user_invocable: false
platform: claude-code
---

# foodorder.today Menu Scraper

Reference skill for extracting menus from 世通線上自助點餐系統 (foodorder.today POS).
