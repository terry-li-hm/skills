---
name: diagnosis
description: Key considerations when debugging — hypothesis discipline, observation hierarchy, when to abandon a theory. Reference skill consulted by systematic-debugging and when debugging gets stuck. Not user-invocable.
version: 1
...
Same asymmetry as planning (see `bouleusis`): humans have rich intuition ("feels like a race condition") that skips 90% of search space. Agents have exhaustive systematic observation that never gets bored.
