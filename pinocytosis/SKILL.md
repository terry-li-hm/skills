...
1. **Pre-flight auth check.** Is the domain in the known-auth list (LinkedIn, X, Google Docs, WeChat, Xiaohongshu)? If yes, skip WebFetch — go directly to the right tool.
