...
```
Query: "Intact Lab Hong Kong hiring data science"
Tool: mcp__google-search__search
```

**Recent news:** Use Brave News
```
Query: "AI regulation news January 2026"
Tool: mcp__brave-search__brave_news_search
```

**Deep extraction:** Use Tavily
```
Query: "company annual report analysis"
Tool: mcp__tavily__tavily-search with search_depth: advanced
```
