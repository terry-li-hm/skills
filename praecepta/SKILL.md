---
name: praecepta
description: Heuristic library — simple action rules that replace per-case reasoning. Consult when making decisions, giving advice, or when a situation triggers a known pattern. Complementary to topica (analytical lenses) and bouleusis (planning theory). Not user-invocable.
