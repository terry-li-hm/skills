---
name: skill-review
description: Monthly review of skills for staleness, drift, and gaps. Use on first Sunday of month or when skills feel out of sync.
user_invocable: true
---
...
- `skills-design` — How skills should be structured
