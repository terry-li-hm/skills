...
name: docima
description: >
  AI agent memory benchmark CLI — compare 10 backends (Mem0, Graphiti, Cognee, etc.)
  on storage, retrieval, and drift. Use when discussing memory backends, running benchmarks,
  or analysing results. NOT for general memory/MEMORY.md work.
