...
4. **Analyze fit** across dimensions (see Fit Dimensions below). Consult `topica` — check for barbell strategy, specific knowledge, compounding, opportunity cost before weighting dimensions.
